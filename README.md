...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/dbt-artifacts-parser-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/dbt-artifacts-parser-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add dbt-artifacts-parser
# for installing globally
pixi global install dbt-artifacts-parser
```
...
It is possible to list all of the versions of `dbt-artifacts-parser` available on your platform:
...
```
pixi search dbt-artifacts-parser --channel conda-forge
```
